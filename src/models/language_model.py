...
from datasets.shapeworld import SHAPES, COLORS, VOCAB
...
if __name__ == '__main__':
    ...
    # Vocab
    vocab = torch.load('./experiments/saved_models/'+str(args.dataset)+'/vocab.pt')
    ...
    torch.save(language_model, './experiments/saved_models/'+str(args.dataset)+'/language-model.pt')